...
export const regions: readonly Region[] = [
  {
    ...
    cities: [
      ...
      { name: "Rome", country: "Italy", countryCode: "IT", currency: "EUR", locale: "it-IT", timezone: "Europe/Rome", depth: "open" },
      { name: "Munich", country: "Germany", countryCode: "DE", currency: "EUR", locale: "de-DE", timezone: "Europe/Berlin", depth: "open" },
      { name: "Brussels", country: "Belgium", countryCode: "BE", currency: "EUR", locale: "fr-BE", timezone: "Europe/Brussels", depth: "open" },
      { name: "Vienna", country: "Austria", countryCode: "AT", currency: "EUR", locale: "de-AT", timezone: "Europe/Vienna", depth: "open" },
      { name: "Budapest", country: "Hungary", countryCode: "HU", currency: "HUF", locale: "hu-HU", timezone: "Europe/Budapest", depth: "open" },
      { name: "Helsinki", country: "Finland", countryCode: "FI", currency: "EUR", locale: "fi-FI", timezone: "Europe/Helsinki", depth: "open" },
      { name: "Tallinn", country: "Estonia", countryCode: "EE", currency: "EUR", locale: "et-EE", timezone: "Europe/Tallinn", depth: "open" },
