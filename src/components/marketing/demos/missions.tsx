...
import { Meter, SampleTag } from "@/components/ui/primitives";
 ...
 * fills as you do it.
 *
 * The prices come from the default city's anchors through `missionPreview`, so
 * "Weekend under €30" is a real €30 rather than a headline with a rounding
 * error under it. Rendered inside the landing page's platform window.
 * ============================================================================
 */
    ...
    <div className="flex min-w-0 flex-col gap-4">
      ...
      {preview ? (
        <motion.div
          ...
          className="rounded-2xl bg-white p-5 shadow-[var(--shadow-raise)] ring-1 ring-ink-950/5"
        >
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div className="min-w-0">
              <h4 className="text-display-xs text-ink-950">
          ...
          <div className="mt-3 flex items-center justify-between gap-3 rounded-lg bg-paper-2 px-4 py-3">
          ...
          <div className="mt-4 flex flex-wrap items-center gap-2">
            ...
            <ButtonLink href="/get-started?intent=mission-cheaper" variant="outline" size="sm">
              Make cheaper
            </ButtonLink>
            <ButtonLink href="/get-started?intent=mission-social" variant="outline" size="sm">
              Make more social
            </ButtonLink>
          </div>

          <div className="mt-4 flex items-center gap-2.5 border-t border-ink-100 pt-4">
            <MascotStill state="explorer" size="xs" />
